...
public class Updater implements Runnable {
    ...
    private org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(Updater.class);
    ...
    public void run() {
        try {
            ...
            Socket client;
            logger.info("Updater: Listening for connections.");
            while (true) {
                ...
                logger.info("Done sending update\n");
