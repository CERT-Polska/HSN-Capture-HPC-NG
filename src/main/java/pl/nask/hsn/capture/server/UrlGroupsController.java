...
public class UrlGroupsController extends Observable implements Runnable, Observer {
    ...
    private long reloadValue = 10;
    private org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(UrlGroupsController.class);
    ...
    public void update(Observable o, Object arg) {
        ...
        if (urlGroup.getUrlGroupState() == URL_GROUP_STATE.VISITING) {
            ...
            if (!split && retry && urlGroup.getErrorCount() <= 1) {
                logger.info("Retrying to visit group " + urlGroup.getIdentifier() + ".");
                urlGroup.setRetryCount(urlGroup.getRetryCount() + 1);
