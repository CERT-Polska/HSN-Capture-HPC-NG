...
public class VirtualMachine extends Observable implements Observer {
    ...
    private org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(VirtualMachine.class);
    ...
    public VirtualMachine(VirtualMachineServer s, String p, String user, String pass, String cpath, String vmid) {
        server = s;
        path = p;
        username = user;
        password = pass;
    ...
    public void setState(VM_STATE newState) {
        ...
        synchronized (this) {
            ...
            logger.info(this.getLogHeader() + " VMSetState: " + newState.toString());
            this.setChanged();
    ...
    public VirtualMachineServer getServer() {
        return server;
    }

    public void setServer(VirtualMachineServer server) {
        this.server = server;
    }
